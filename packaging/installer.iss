...
AppName={#ProductName}
OutputBaseFilename="{#ProductName}_{#Version}_Windows_Installer_{#GetEnv('SC_BUILD_DATETIME')}"
...
[Files]
Source: "{#SC_BUILD_DIR}\StereoCreator_artefacts\Debug\VST3\{#ProductName}.vst3\*"; DestDir: "{commoncf64}\VST3\{#ProductName}.vst3\"; Excludes: *.ilk; Flags: ignoreversion recursesubdirs;
